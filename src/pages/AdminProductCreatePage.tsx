...
export default function AdminProductCreatePage() {
  ...
  const outline = isDark ? 'outline-slate-700' : 'outline-neutral-200'
          ...
          <main className="flex-1 p-6 flex flex-col gap-5">
            ...
            <div className="inline-flex flex-col justify-start items-start gap-4 w-full">
              <div className="inline-flex justify-between items-center w-full gap-6">
                <div className="inline-flex flex-col justify-start items-start gap-1">
                  <div className={`justify-start ${textMain} text-2xl font-semibold font-['Rubik']`}>Create Product</div>
            ...
            <div className={`${cardBg} rounded-2xl p-6 w-full`}>
              <div className="w-full grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-6 items-start">
                ...
                <div className="inline-flex flex-col justify-start items-start gap-6">
                  ...
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                      <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="Enter product name" />
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <div className={`h-44 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-start w-full bg-white dark:bg-slate-900/60`}>
                      <textarea className={`flex-1 bg-transparent outline-none resize-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="Write a short description" />
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                      <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="e.g. Sneaker" />
                    </div>
                  </div>
                  ...
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                      <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="e.g. Adidas" />
                    </div>
                  </div>
                  ...
                  <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                        <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="#32A53" />
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                      <div className={`justify-start ${textSub} text-xl font-semibold font-['Rubik']`}>Stock Quantity</div>
                      <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                        <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="e.g. 211" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className={`h-12 px-4 py-2.5 rounded-lg shadow-[0px_4px_20px_0px_rgba(0,0,0,0.10)] outline outline-1 ${outline} inline-flex items-center w-full bg-white dark:bg-slate-900/60`}>
                        <input className={`flex-1 bg-transparent outline-none ${isDark ? 'text-slate-200' : 'text-neutral-900'} text-base font-normal font-['Inter'] tracking-wide`} placeholder="₹110.40" />
                      </div>
                    </div>
                    <div className="flex flex-col gap-2">
                  ...
                  <div className="w-full flex flex-col gap-2">
                    ...
                    <div className={`h-24 p-4 rounded-lg outline outline-1 ${outline} inline-flex items-start gap-2 w-full bg-white dark:bg-slate-900/60`}>
              ...
              <div className="w-full flex justify-end items-center gap-3 mt-6">
                <button className="h-10 px-5 rounded-lg bg-neutral-900 text-white text-sm font-medium">CREATE</button>
                <button className={`h-10 px-5 rounded-lg outline outline-1 ${outline} text-sm font-medium ${isDark ? 'text-slate-200' : 'text-neutral-800'}`} onClick={() => navigate(-1)}>CANCEL</button>
              </div>
            </div>
          </main>
        </div>
